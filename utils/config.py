...
CONFIG.model.imagenet_pretrain_path = CONFIG.root_path + "pretrain/model_best_resnet34_En_nomixup.pth"
...
CONFIG.data.pupil_bg = None
CONFIG.data.real_image = None
...
CONFIG.train.D_lr = 0.001
# beta1 and beta2 for Adam
CONFIG.train.beta1 = 0.5
CONFIG.train.beta2 = 0.999

# weight of different losses
CONFIG.train.rec_weight = 3
# CONFIG.train.atten_weight = 0.5
CONFIG.train.dis_weight = 0.25
CONFIG.train.use_da = True

# for baseline and GCA, use the weight settings below
# CONFIG.train.rec_weight = 1
# CONFIG.train.dis_weight = 0
# CONFIG.train.use_da = False

CONFIG.train.rmi_weight = 0
CONFIG.train.ssim_weight = 0
...
# Logging config
CONFIG.log = EasyDict({})
CONFIG.log.tensorboard_path = CONFIG.root_path + "logs/tensorboard"
CONFIG.log.tensorboard_step = 100
# save less images to save disk space
CONFIG.log.tensorboard_image_step = 500
CONFIG.log.logging_path = CONFIG.root_path + "logs/stdout"
CONFIG.log.logging_step = 10
CONFIG.log.logging_level = "DEBUG"
CONFIG.log.checkpoint_path = CONFIG.root_path + "checkpoints"
