...
class ImageFileTrain(ImageFile):
    def __init__(self,
        ...
        self.valid_real_image_list = [os.path.splitext(name)[0] for name in os.listdir(self.real_dir)]
        ...
        self.real_image = self._list_abspath(self.fg_dir, self.fg_ext, self.valid_fg_list)
        ...
        self.real_image = self._list_abspath(self.real_dir, self.real_ext, self.valid_real_image_list)
